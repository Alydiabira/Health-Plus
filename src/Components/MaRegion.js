...
import "../Styles/MaRegion.css";

function MaRegion() {
  return (
    <div className="maregion-section" id="services">
      <div className="maregion-title-content">
        <h3 className="maregion-title">
          <span>What We Do</span>
        </h3> 
        <p className="maregion-description">
      ...
      <div className="maregion-cards-content">
        <InformationCard
